/*
===================================================================
===        SCRIPT TẠO CẤU TRÚC HOÀN CHỈNH CHO CSDL CAFEBOOK      ===
===               (ĐÃ TỔNG HỢP TỪ TẤT CẢ CÁC FILE)              ===
===================================================================
*/

-- =============================================
-- ===         NHÓM BẢNG CƠ BẢN (TẠO TRƯỚC)    ===
-- =============================================
...
CREATE TABLE [dbo].[PhieuThueSach] (
    ...
    [trangThai]      NVARCHAR (50)   NOT NULL,
    [phiThue]        DECIMAL(18, 2)  NOT NULL DEFAULT 0,
